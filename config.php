...
*
* Possible DB configuration options
*
...
if(!defined('NSM_ENV')) {
    ...
    define('NSM_BASE_PATH', realpath(__DIR__ . "/.."));
    define('NSM_CONTENT_PATH', realpath(NSM_BASE_PATH . "/public"));
...
elseif(NSM_ENV == 'mobile') {
    ...
    $env_config['tmpl_file_basepath'] = NSM_BASE_PATH . '/templates_mobile/';
}
else {
    $env_global_vars = array(
        'global:cm_subscriber_list_slug' => '',
        'global:google_analytics_key' => '13200356-1'
    );
}
...
if(isset($config)) {
    ...
    */
    $default_global_vars = array(
        ...
        // NSM Gravatar
        'global:nsm_gravatar_default_avatar' => NSM_CONTENT_PATH . '/images/avatars/default.png',
    ...
    $default_config = array(
        ...
        // General preferences
        'is_system_on' => 'y',
        'license_number' => '3944-2161-9917-9943',
        ...
        'tmpl_file_basepath' => NSM_BASE_PATH . '/templates/',

        // Theme preferences
        'theme_folder_path' => NSM_CONTENT_PATH . '/themes/',
        ...
        'prv_msg_upload_path' => NSM_CONTENT_PATH . '/images/pm_attachments',
        'enable_emoticons' => 'n',

        'enable_avatars' => 'n',
        'avatar_path' => NSM_CONTENT_PATH . '/images/avatars/',
        ...
        'enable_photos' => 'n',
        'photo_path' => NSM_CONTENT_PATH . '/images/member_photos/',
        ...
        'sig_img_path' => NSM_CONTENT_PATH . '/images/signature_attachments/',
        ...
        'captcha_path' => NSM_CONTENT_PATH . '/images/captchas/',
        ...
        'nsm_htaccess_generator_path' => array(NSM_CONTENT_PATH . "/.htaccess")
    );
